...
export const t = {
  ...
  adminCategories: {
    title: 'Catégories',
    subtitle: 'Créez et gérez les catégories du catalogue.',
    create: 'Créer une catégorie',
    count: (n: string) => `${n} catégorie(s)`,
    colName: 'Nom',
    colSlug: 'Slug',
    ...
    emptyDesc: 'Créez votre première catégorie de produits.',
    ...
    actionError: 'Échec de l’action',
    deleteConfirm: (name: string) => `Supprimer la catégorie « ${name} » ? Action irréversible.`,
    formTitle: 'Nouvelle catégorie',
    editTitle: 'Modifier la catégorie',
    fName: 'Nom',
    fNamePlaceholder: 'Électronique',
    fSlug: 'Slug',
    fSlugPlaceholder: 'electronique (généré si vide)',
    fDescription: 'Description',
    fIcon: 'Icône (emoji ou nom)',
    optional: '(facultatif)',
    save: 'Enregistrer',
    saving: 'Enregistrement…',
    cancel: 'Annuler',
  ...
  // Disputes / litiges — shared status + reason labels
  disputeStatus: {
    open: 'Ouvert',
  ...
  // Buyer-side dispute (order detail)
  disputes: {
    open: 'Signaler un problème',
    title: 'Signaler un problème sur cette commande',
    reasonLabel: 'Motif',
    descriptionLabel: 'Description',
    descriptionPlaceholder: 'Décrivez le problème rencontré (10 caractères min.)…',
    submit: 'Envoyer le signalement',
    submitting: 'Envoi…',
    cancel: 'Annuler',
    existing: 'Litige en cours',
    existingResolved: 'Litige clôturé',
    created: 'Votre signalement a été envoyé. Notre équipe va l’examiner.',
    error: 'Impossible d’envoyer le signalement',
    resolutionLabel: 'Réponse de l’équipe',
  },
  // Admin disputes (`/admin/disputes`)
  adminDisputes: {
    title: 'Litiges',
    subtitle: 'Examinez et traitez les réclamations des clients.',
    count: (n: string) => `${n} litige(s)`,
    filterAll: 'Tous',
    colOrder: 'Commande',
    colCustomer: 'Client',
    colReason: 'Motif',
    ...
    colActions: 'Actions',
    empty: 'Aucun litige.',
    emptyDesc: 'Les réclamations clients apparaîtront ici.',
    ...
    markUnderReview: 'Mettre en cours d’examen',
    resolve: 'Résoudre',
    reject: 'Rejeter',
    resolutionLabel: 'Réponse / résolution',
